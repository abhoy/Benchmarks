...
gate mcx_140140895605600 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
qreg q[11];
creg c[11];
cx q[4],q[0];
cx q[10],q[0];
...
mcx_140140895605600 q[10],q[8],q[7],q[4],q[2];
