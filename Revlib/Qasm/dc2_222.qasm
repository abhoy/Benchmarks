...
gate mcx_139997340889056 q0,q1,q2,q3 { h q3; p(pi/8) q0; p(pi/8) q1; p(pi/8) q2; p(pi/8) q3; cx q0,q1; p(-pi/8) q1; cx q0,q1; cx q1,q2; p(-pi/8) q2; cx q0,q2; p(pi/8) q2; cx q1,q2; p(-pi/8) q2; cx q0,q2; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; h q3; }
gate mcx_gray q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_gray_139997340888288 q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_139997340892176 q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
qreg q[15];
creg c[15];
cx q[7],q[0];
x q[14];
mcx q[14],q[13],q[12],q[11],q[6];
x q[10];
mcx_139997340889056 q[14],q[10],q[8],q[1];
mcx q[14],q[10],q[9],q[2];
mcx q[14],q[12],q[10],q[5];
mcx q[14],q[12],q[10],q[3];
mcx q[14],q[12],q[10],q[2];
mcx q[14],q[11],q[10],q[3];
mcx q[14],q[11],q[10],q[2];
mcx q[14],q[11],q[10],q[1];
mcx q[14],q[13],q[12],q[10],q[5];
mcx q[14],q[13],q[12],q[10],q[3];
x q[12];
mcx q[14],q[13],q[12],q[5];
mcx q[14],q[13],q[12],q[4];
mcx_gray q[14],q[12],q[11],q[10],q[9],q[8],q[3];
x q[12];
x q[11];
ccx q[14],q[11],q[4];
mcx_gray_139997340888288 q[14],q[13],q[12],q[11],q[10],q[4];
mcx q[14],q[13],q[12],q[11],q[4];
mcx q[14],q[12],q[11],q[10],q[5];
mcx q[14],q[12],q[11],q[10],q[3];
mcx_gray q[14],q[12],q[11],q[10],q[9],q[3];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[6];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[4];
x q[12];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[3];
x q[14];
x q[11];
x q[13];
mcx q[14],q[13],q[12],q[6];
mcx_gray q[13],q[12],q[11],q[10],q[9],q[8],q[4];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[8],q[2];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[14],q[13],q[12],q[10],q[8],q[1];
mcx_gray q[14],q[13],q[12],q[10],q[9],q[2];
mcx_gray_139997340892176 q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[3];
x q[14];
mcx q[13],q[12],q[11],q[4];
ccx q[13],q[12],q[4];
x q[12];
x q[13];
x q[8];
mcx q[14],q[11],q[10],q[8],q[2];
x q[10];
x q[9];
mcx_gray q[14],q[11],q[10],q[9],q[8],q[4];
mcx_gray q[14],q[11],q[10],q[9],q[8],q[1];
mcx_gray q[14],q[12],q[10],q[9],q[8],q[3];
mcx_gray q[14],q[12],q[10],q[9],q[8],q[2];
mcx_gray q[14],q[13],q[10],q[9],q[8],q[4];
mcx_gray q[14],q[13],q[11],q[10],q[9],q[8],q[3];
mcx_gray q[14],q[13],q[11],q[9],q[8],q[3];
x q[11];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[6];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[4];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[3];
x q[11];
x q[13];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[8],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[8],q[4];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[8],q[3];
x q[14];
x q[12];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[1];
x q[11];
mcx_gray q[13],q[12],q[11],q[10],q[9],q[8],q[3];
