...
gate mcx_gray_140652530923168 q0,q1,q2,q3,q4,q5,q6,q7,q8 { h q8; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7,q8; h q8; }
gate mcx_140652528563728 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
qreg q[10];
creg c[10];
x q[0];
cx q[3],q[2];
...
x q[5];
ccx q[9],q[8],q[7];
mcx_gray_140652530923168 q[0],q[1],q[2],q[3],q[4],q[5],q[6],q[7],q[9];
ccx q[9],q[8],q[7];
...
mcx_140652528563728 q[1],q[2],q[3],q[4],q[9];
mcx_gray q[5],q[6],q[7],q[8],q[9],q[4];
...
x q[5];
mcx q[0],q[3],q[4],q[2];
mcx_gray q[5],q[6],q[7],q[8],q[9],q[0];
mcx q[0],q[3],q[4],q[2];
