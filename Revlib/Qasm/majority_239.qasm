...
gate mcx_139787818480544 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
...
x q[2];
mcx q[4],q[3],q[2],q[0];
mcx_139787818480544 q[5],q[3],q[2],q[1],q[0];
mcx q[5],q[4],q[2],q[1],q[0];
x q[5];
x q[1];
mcx_gray q[5],q[4],q[3],q[2],q[1],q[0];
