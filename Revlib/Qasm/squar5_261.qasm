...
gate mcx_139660652468576 q0,q1,q2,q3 { h q3; p(pi/8) q0; p(pi/8) q1; p(pi/8) q2; p(pi/8) q3; cx q0,q1; p(-pi/8) q1; cx q0,q1; cx q1,q2; p(-pi/8) q2; cx q0,q2; p(pi/8) q2; cx q1,q2; p(-pi/8) q2; cx q0,q2; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; h q3; }
...
ccx q[10],q[9],q[3];
ccx q[10],q[9],q[2];
mcx_139660652468576 q[12],q[11],q[8],q[4];
x q[10];
ccx q[12],q[10],q[6];
ccx q[12],q[10],q[5];
mcx q[12],q[10],q[8],q[3];
mcx_gray q[12],q[11],q[10],q[9],q[8],q[4];
mcx q[11],q[10],q[9],q[4];
...
mcx q[12],q[11],q[10],q[3];
mcx_gray q[12],q[11],q[10],q[9],q[8],q[7];
mcx_gray q[12],q[11],q[10],q[9],q[8],q[6];
mcx_gray q[12],q[11],q[10],q[9],q[8],q[5];
mcx_gray q[12],q[11],q[10],q[9],q[8],q[4];
x q[9];
mcx q[12],q[11],q[9],q[5];
x q[12];
x q[8];
mcx q[12],q[11],q[10],q[8],q[3];
