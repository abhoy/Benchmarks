...
gate mcx_140110613156176 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
gate mcx_gray q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_140110613157760 q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
gate mcx_gray_140110613158528 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
qreg q[19];
creg c[19];
...
mcx_140110613156176 q[16],q[15],q[14],q[10],q[1];
...
ccx q[13],q[7],q[0];
x q[16];
mcx_gray q[17],q[16],q[15],q[11],q[8],q[1];
mcx_gray q[17],q[16],q[11],q[9],q[8],q[1];
mcx q[17],q[16],q[11],q[3];
mcx_gray q[18],q[16],q[12],q[11],q[9],q[2];
mcx_gray q[18],q[16],q[12],q[11],q[9],q[1];
mcx_gray q[18],q[17],q[16],q[12],q[9],q[2];
mcx_gray q[18],q[17],q[16],q[12],q[9],q[1];
x q[10];
mcx_gray_140110613157760 q[18],q[15],q[14],q[12],q[11],q[10],q[7],q[0];
mcx_gray q[18],q[17],q[15],q[14],q[12],q[10],q[7],q[0];
mcx_gray q[17],q[11],q[10],q[9],q[8],q[1];
mcx_gray q[17],q[15],q[11],q[10],q[8],q[1];
ccx q[16],q[10],q[4];
x q[17];
mcx q[18],q[17],q[12],q[4];
mcx_gray_140110613158528 q[18],q[17],q[15],q[14],q[12],q[10],q[1];
mcx_gray q[18],q[17],q[15],q[12],q[10],q[8],q[7],q[0];
mcx_gray q[18],q[17],q[12],q[10],q[9],q[2];
mcx_gray q[18],q[17],q[12],q[10],q[9],q[1];
mcx_gray q[18],q[17],q[12],q[10],q[9],q[0];
mcx_gray q[18],q[17],q[12],q[10],q[9],q[8],q[1];
mcx_gray q[18],q[17],q[15],q[12],q[10],q[2];
mcx_gray q[18],q[17],q[15],q[12],q[10],q[1];
mcx q[18],q[17],q[12],q[10],q[3];
mcx_gray q[18],q[17],q[14],q[13],q[12],q[10],q[9],q[0];
x q[10];
mcx q[18],q[17],q[16],q[12],q[3];
mcx q[18],q[17],q[16],q[12],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[0];
x q[11];
mcx q[18],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[15],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[15],q[12],q[11],q[10],q[1];
x q[10];
mcx_gray q[18],q[12],q[11],q[10],q[9],q[2];
mcx_gray q[18],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[14],q[12],q[11],q[10],q[9],q[7],q[0];
mcx_gray q[18],q[15],q[12],q[11],q[10],q[8],q[7],q[0];
mcx_gray q[18],q[15],q[13],q[12],q[11],q[10],q[8],q[0];
...
mcx_gray q[18],q[17],q[13],q[12],q[10],q[9],q[8],q[0];
x q[10];
mcx_gray q[18],q[13],q[12],q[11],q[10],q[9],q[8],q[0];
mcx_gray q[18],q[16],q[15],q[13],q[12],q[11],q[8],q[0];
x q[16];
mcx_gray q[18],q[16],q[13],q[12],q[11],q[9],q[8],q[0];
x q[14];
mcx q[16],q[14],q[10],q[9],q[1];
mcx q[15],q[14],q[9],q[1];
x q[10];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[18],q[17],q[15],q[14],q[12],q[10],q[0];
mcx_gray q[18],q[17],q[14],q[12],q[10],q[9],q[7],q[0];
mcx_gray q[18],q[17],q[14],q[12],q[10],q[9],q[1];
mcx_gray q[18],q[14],q[12],q[11],q[10],q[9],q[1];
x q[10];
mcx_gray q[16],q[14],q[13],q[10],q[9],q[0];
mcx_gray q[16],q[15],q[14],q[13],q[10],q[0];
x q[16];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[9],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[0];
x q[7];
x q[10];
mcx_gray q[18],q[12],q[11],q[10],q[9],q[8],q[7],q[0];
ccx q[13],q[7],q[1];
x q[13];
mcx q[15],q[14],q[9],q[7],q[0];
x q[8];
mcx_gray q[18],q[16],q[15],q[12],q[11],q[8],q[1];
mcx_gray q[18],q[16],q[12],q[11],q[9],q[8],q[1];
mcx_gray q[18],q[17],q[16],q[12],q[9],q[8],q[1];
mcx_gray q[18],q[17],q[16],q[12],q[9],q[8],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[8],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[8],q[0];
mcx_gray q[18],q[17],q[15],q[13],q[12],q[10],q[8],q[0];
mcx_gray q[18],q[17],q[15],q[12],q[10],q[8],q[1];
mcx q[15],q[9],q[8],q[7],q[0];
mcx q[15],q[9],q[8],q[0];
mcx_gray q[18],q[16],q[15],q[12],q[11],q[8],q[7],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[8],q[7],q[0];
mcx_gray q[18],q[17],q[16],q[12],q[9],q[8],q[7],q[0];
mcx_gray q[18],q[17],q[12],q[10],q[9],q[8],q[7],q[0];
x q[17];
mcx_gray q[18],q[16],q[12],q[11],q[9],q[8],q[7],q[0];
x q[11];
ccx q[14],q[8],q[2];
x q[15];
mcx q[17],q[15],q[11],q[10],q[2];
mcx_gray q[17],q[15],q[11],q[10],q[7],q[0];
mcx_gray q[17],q[16],q[15],q[14],q[11],q[7],q[0];
x q[7];
mcx_gray q[17],q[15],q[11],q[10],q[8],q[7],q[0];
mcx_gray q[17],q[15],q[14],q[11],q[10],q[0];
mcx_gray q[17],q[15],q[14],q[13],q[11],q[10],q[0];
mcx q[17],q[16],q[15],q[11],q[2];
x q[14];
mcx_gray q[17],q[15],q[14],q[11],q[10],q[1];
mcx_gray q[17],q[16],q[15],q[14],q[11],q[1];
mcx_gray q[17],q[16],q[15],q[11],q[8],q[7],q[0];
mcx_gray q[17],q[16],q[15],q[13],q[11],q[8],q[0];
x q[16];
mcx_gray q[17],q[15],q[13],q[11],q[10],q[8],q[0];
x q[10];
mcx q[16],q[15],q[10],q[8],q[1];
x q[7];
mcx_gray q[16],q[15],q[14],q[10],q[7],q[0];
mcx_gray q[17],q[15],q[14],q[11],q[10],q[7],q[0];
mcx_gray q[17],q[15],q[14],q[11],q[7],q[0];
x q[13];
mcx_gray q[16],q[15],q[10],q[8],q[7],q[0];
mcx q[16],q[15],q[10],q[7],q[0];
mcx_gray q[16],q[15],q[13],q[10],q[8],q[0];
x q[16];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[11],q[0];
mcx_gray q[17],q[16],q[15],q[13],q[11],q[0];
x q[16];
x q[13];
x q[11];
mcx_gray q[18],q[16],q[15],q[12],q[11],q[2];
mcx_gray q[18],q[16],q[15],q[12],q[11],q[1];
mcx_gray q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[18],q[15],q[12],q[11],q[10],q[8],q[1];
mcx_gray q[18],q[15],q[12],q[11],q[8],q[1];
x q[16];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[1];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[0];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[7],q[0];
mcx_gray q[18],q[16],q[15],q[12],q[11],q[7],q[0];
x q[11];
x q[17];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[8],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[7],q[0];
x q[7];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[7],q[0];
x q[17];
x q[9];
mcx q[17],q[16],q[11],q[9],q[2];
mcx_gray q[17],q[16],q[11],q[9],q[8],q[7],q[0];
mcx_gray q[17],q[16],q[11],q[9],q[7],q[0];
mcx_gray q[17],q[16],q[14],q[11],q[9],q[7],q[0];
mcx_gray q[17],q[16],q[14],q[11],q[9],q[1];
mcx_gray q[17],q[16],q[13],q[11],q[9],q[8],q[0];
x q[16];
mcx_gray q[16],q[13],q[10],q[9],q[8],q[0];
mcx q[16],q[10],q[9],q[8],q[1];
mcx q[16],q[10],q[9],q[8],q[0];
x q[8];
ccx q[15],q[9],q[3];
x q[7];
mcx_gray q[16],q[10],q[9],q[8],q[7],q[0];
mcx_gray q[16],q[14],q[10],q[9],q[7],q[0];
x q[10];
mcx q[17],q[11],q[10],q[9],q[2];
mcx_gray q[17],q[14],q[11],q[10],q[9],q[1];
mcx_gray q[17],q[14],q[11],q[10],q[9],q[0];
mcx_gray q[17],q[11],q[10],q[9],q[8],q[7],q[0];
mcx_gray q[17],q[14],q[11],q[10],q[9],q[7],q[0];
mcx_gray q[17],q[11],q[10],q[9],q[8],q[0];
x q[8];
mcx_gray q[17],q[13],q[11],q[10],q[9],q[8],q[0];
x q[14];
mcx_gray q[17],q[16],q[14],q[13],q[11],q[9],q[0];
mcx_gray q[17],q[14],q[13],q[11],q[10],q[9],q[0];
mcx_gray q[17],q[14],q[13],q[11],q[9],q[0];
x q[14];
x q[11];
x q[16];
mcx_gray q[18],q[16],q[14],q[12],q[11],q[9],q[1];
mcx_gray q[18],q[16],q[14],q[12],q[11],q[9],q[0];
mcx_gray q[18],q[16],q[14],q[13],q[12],q[11],q[9],q[0];
mcx_gray q[18],q[14],q[13],q[12],q[11],q[10],q[9],q[0];
mcx_gray q[18],q[12],q[11],q[10],q[9],q[8],q[1];
x q[17];
mcx_gray q[18],q[17],q[16],q[14],q[12],q[9],q[1];
mcx_gray q[18],q[17],q[16],q[13],q[12],q[9],q[8],q[0];
x q[14];
mcx_gray q[18],q[16],q[14],q[12],q[11],q[9],q[7],q[0];
mcx_gray q[18],q[17],q[16],q[14],q[12],q[9],q[7],q[0];
x q[12];
cx q[12],q[6];
ccx q[18],q[12],q[5];
ccx q[18],q[12],q[4];
