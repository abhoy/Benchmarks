...
gate mcx_140073066403616 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
gate mcx_gray q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
qreg q[13];
creg c[13];
mcx q[10],q[7],q[6],q[4];
mcx q[10],q[7],q[6],q[3];
mcx_140073066403616 q[12],q[11],q[10],q[6],q[4];
x q[3];
x q[2];
x q[1];
x q[0];
...
ccx q[10],q[6],q[2];
ccx q[10],q[6],q[1];
mcx q[12],q[10],q[7],q[6],q[4];
ccx q[9],q[5],q[1];
ccx q[9],q[5],q[0];
mcx q[9],q[7],q[6],q[5],q[3];
mcx q[10],q[9],q[7],q[5],q[3];
ccx q[11],q[7],q[3];
ccx q[11],q[7],q[2];
mcx q[12],q[11],q[7],q[4];
ccx q[12],q[8],q[4];
ccx q[12],q[8],q[3];
mcx q[11],q[8],q[7],q[4];
x q[8];
x q[6];
mcx q[11],q[9],q[6],q[5],q[3];
mcx q[9],q[6],q[5],q[2];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[4];
mcx_gray q[11],q[9],q[8],q[6],q[5],q[4];
x q[12];
mcx_gray q[12],q[10],q[9],q[7],q[5],q[4];
ccx q[12],q[8],q[3];
mcx_gray q[12],q[11],q[9],q[6],q[5],q[4];
x q[10];
mcx q[10],q[9],q[5],q[3];
mcx q[10],q[9],q[5],q[2];
ccx q[10],q[6],q[1];
x q[6];
mcx_gray q[12],q[9],q[7],q[6],q[5],q[4];
mcx_gray q[12],q[11],q[10],q[9],q[5],q[4];
x q[10];
x q[11];
mcx q[11],q[10],q[6],q[4];
mcx q[11],q[10],q[6],q[3];
mcx q[11],q[10],q[8],q[6],q[4];
x q[10];
mcx q[11],q[10],q[9],q[5],q[3];
mcx_gray q[11],q[10],q[9],q[8],q[5],q[4];
x q[7];
ccx q[11],q[7],q[2];
mcx q[10],q[8],q[7],q[6],q[4];
mcx q[8],q[7],q[6],q[4];
mcx_gray q[10],q[9],q[8],q[7],q[5],q[4];
x q[9];
x q[5];
ccx q[9],q[5],q[0];
