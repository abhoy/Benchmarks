...
gate mcx_140461369995904 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
qreg q[6];
creg c[6];
mcx q[5],q[3],q[2],q[0];
x q[5];
...
ccx q[4],q[3],q[0];
x q[3];
mcx_140461369995904 q[5],q[4],q[3],q[1],q[0];
