...
gate mcx_gray_139670223261936 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_gray_139670223262512 q0,q1,q2,q3,q4,q5,q6,q7,q8,q9 { h q9; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7,q8,q9; h q9; }
gate mcx_gray_139670223263424 q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
gate mcx_gray_139670223263952 q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_139670223359088 q0,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10 { h q10; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10; h q10; }
qreg q[20];
creg c[20];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray_139670223261936 q[19],q[18],q[16],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[0];
mcx_gray_139670223262512 q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[15],q[14],q[13],q[12],q[11],q[1];
x q[13];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray_139670223263424 q[19],q[17],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[18],q[16],q[14],q[13],q[12],q[11],q[1];
x q[18];
mcx_gray_139670223263952 q[18],q[17],q[16],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[1];
x q[13];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[12],q[11],q[1];
x q[18];
x q[13];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[8];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
x q[18];
x q[13];
x q[19];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
x q[13];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[0];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[3];
x q[13];
x q[19];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[1];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray_139670223359088 q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[3];
x q[19];
x q[18];
x q[16];
x q[14];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
x q[16];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[8];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[1];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[3];
x q[19];
x q[13];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
x q[16];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[6];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[6];
x q[16];
x q[19];
x q[13];
x q[18];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[1];
x q[13];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[4];
x q[16];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[6];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[1];
x q[13];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[3];
x q[16];
x q[19];
x q[14];
x q[10];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[1];
x q[16];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
x q[18];
x q[14];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[2];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
x q[16];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[10],q[2];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[10],q[1];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
x q[14];
x q[18];
x q[16];
x q[13];
x q[19];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[12],q[11],q[10],q[6];
x q[13];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
x q[13];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[11],q[10],q[2];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[0];
x q[18];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[0];
x q[14];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
x q[18];
x q[16];
x q[19];
x q[10];
x q[11];
mcx_gray q[19],q[17],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[9];
x q[14];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[7];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
x q[14];
x q[10];
mcx_gray q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[11],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
x q[19];
mcx_gray q[19],q[18],q[17],q[13],q[11],q[10],q[3];
x q[18];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
x q[14];
mcx_gray q[19],q[18],q[17],q[14],q[11],q[10],q[6];
x q[10];
x q[19];
mcx_gray q[19],q[18],q[17],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[2];
x q[14];
x q[19];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[16],q[15],q[14],q[11],q[10],q[9];
x q[19];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[2];
x q[10];
mcx_gray q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
x q[14];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
x q[18];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
x q[10];
x q[19];
x q[16];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[18],q[17],q[15],q[13],q[12],q[11],q[9];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[6];
x q[16];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
...
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
x q[18];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[3];
x q[18];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[0];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[0];
x q[16];
x q[14];
x q[10];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[2];
x q[19];
x q[14];
mcx_gray q[19],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
x q[18];
x q[16];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
x q[19];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[11],q[10],q[5];
x q[14];
x q[19];
x q[16];
x q[13];
x q[11];
x q[12];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[2];
x q[10];
x q[13];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[3];
x q[14];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[6];
x q[13];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
...
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
x q[13];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
x q[14];
x q[16];
x q[11];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[13],q[12],q[11],q[5];
x q[13];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[4];
x q[16];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[18],q[17],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
x q[16];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
x q[13];
...
x q[19];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[12],q[10],q[5];
x q[11];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
x q[11];
x q[14];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[2];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
x q[14];
x q[13];
...
x q[16];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[3];
x q[16];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
x q[14];
x q[16];
x q[13];
x q[10];
mcx_gray q[19],q[17],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[13],q[12],q[11],q[10],q[1];
x q[11];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[11];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
x q[14];
x q[13];
mcx_gray q[19],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[16],q[15],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[7];
x q[11];
...
x q[19];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[6];
x q[10];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[14],q[12],q[11],q[10],q[0];
x q[13];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[14],q[13],q[12],q[11],q[10],q[6];
x q[16];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[14],q[13],q[12],q[11],q[10],q[1];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[0];
mcx_gray q[18],q[17],q[16],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[2];
x q[14];
x q[13];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[2];
x q[16];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
x q[11];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[16],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[2];
x q[16];
mcx_gray q[19],q[18],q[16],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
...
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[2];
x q[16];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
...
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[8];
x q[19];
x q[10];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[3];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
x q[19];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
...
x q[16];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[6];
x q[11];
x q[19];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
x q[19];
x q[10];
x q[18];
...
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[9];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
x q[10];
mcx_gray q[19],q[17],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[15],q[13],q[12],q[11],q[10],q[3];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[0];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[10],q[4];
x q[10];
x q[11];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[4];
...
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[11],q[10],q[6];
x q[10];
mcx_gray q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[7];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[7];
x q[11];
mcx_gray q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
...
x q[10];
x q[12];
mcx_gray q[18],q[17],q[15],q[13],q[12],q[11],q[0];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[17],q[16],q[15],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[4];
x q[14];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[10],q[3];
x q[14];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[17],q[14],q[13],q[12],q[11],q[10],q[1];
x q[11];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
x q[10];
x q[14];
x q[19];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
...
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[0];
x q[19];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[0];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[10],q[1];
x q[12];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[1];
x q[10];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[0];
x q[19];
x q[11];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[1];
x q[10];
x q[19];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
...
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[1];
x q[12];
x q[10];
mcx_gray q[19],q[17],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[14],q[13],q[12],q[11],q[10],q[1];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[11],q[10],q[1];
x q[12];
x q[11];
x q[19];
x q[14];
x q[13];
x q[18];
mcx_gray q[18],q[17],q[15],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[3];
x q[10];
x q[11];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[0];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
x q[11];
x q[10];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[10],q[3];
x q[11];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[3];
x q[13];
x q[11];
...
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[6];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[10],q[1];
x q[13];
x q[10];
x q[19];
x q[12];
mcx_gray q[19],q[18],q[17],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
...
x q[11];
x q[13];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
...
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[13];
x q[11];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
...
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[0];
x q[11];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[0];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[0];
x q[11];
x q[19];
x q[14];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[1];
x q[10];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
x q[19];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[13];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
x q[10];
x q[13];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[0];
...
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[2];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
...
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[4];
x q[13];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[2];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[7];
x q[11];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[7];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
...
x q[12];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[10],q[0];
x q[18];
x q[12];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
...
x q[19];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[12],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[5];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
...
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[10],q[1];
x q[18];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[13],q[10],q[0];
x q[19];
x q[12];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[4];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
x q[14];
...
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[14];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[5];
...
x q[12];
x q[14];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[14],q[13],q[12],q[11],q[10],q[3];
x q[14];
x q[19];
x q[12];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[4];
x q[16];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[8];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[3];
x q[16];
x q[10];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
...
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[0];
x q[10];
x q[14];
...
mcx_gray q[19],q[17],q[16],q[15],q[14],q[11],q[10],q[3];
x q[16];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[4];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[7];
x q[16];
x q[10];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[11],q[0];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[7];
...
x q[16];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[7];
x q[14];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[0];
x q[14];
x q[16];
x q[13];
x q[19];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[9];
x q[10];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[13];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
x q[10];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[11],q[10],q[1];
x q[13];
x q[16];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[7];
x q[13];
x q[14];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[0];
x q[16];
x q[14];
x q[18];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[0];
x q[14];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[6];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[0];
x q[10];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[0];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
...
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[15],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[15],q[13],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
...
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[5];
x q[16];
mcx_gray q[18],q[17],q[16],q[15],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[0];
x q[14];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[13];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[10],q[7];
...
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[10],q[1];
...
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[10],q[1];
x q[14];
x q[19];
x q[16];
x q[18];
x q[17];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[11],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
x q[10];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[0];
x q[13];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[3];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[5];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[4];
x q[18];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[4];
...
x q[18];
x q[13];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
x q[18];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[15],q[13],q[12],q[11],q[10],q[2];
x q[18];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[11],q[10],q[0];
x q[13];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[5];
...
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
x q[18];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[3];
...
x q[19];
x q[13];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[10],q[3];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[10],q[0];
x q[18];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[2];
...
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[15],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[10],q[3];
x q[18];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[3];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[6];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[2];
x q[18];
x q[19];
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
x q[14];
x q[18];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[5];
x q[14];
x q[19];
x q[18];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[0];
x q[16];
x q[18];
x q[13];
x q[10];
...
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[0];
x q[19];
x q[16];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[17],q[15],q[14],q[13],q[12],q[10],q[5];
x q[13];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
...
x q[14];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[10],q[1];
x q[16];
x q[18];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[10],q[1];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
x q[18];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
x q[18];
...
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[10],q[3];
x q[10];
x q[14];
x q[18];
x q[16];
...
x q[18];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[1];
...
x q[18];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[0];
x q[10];
x q[13];
x q[19];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[10],q[9];
...
x q[16];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[2];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
x q[18];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[10],q[7];
...
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[10],q[3];
...
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
x q[17];
x q[10];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[12],q[11],q[10],q[0];
x q[12];
mcx_gray q[19],q[18],q[17],q[15],q[12],q[11],q[10],q[3];
x q[17];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[12],q[11],q[10],q[4];
x q[12];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
...
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[1];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
x q[12];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
...
mcx_gray q[19],q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[1];
x q[14];
mcx_gray q[19],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
x q[17];
mcx_gray q[19],q[18],q[17],q[15],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[10],q[3];
...
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[11],q[0];
mcx_gray q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[0];
x q[12];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
...
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[6];
...
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[12],q[11],q[4];
x q[12];
x q[10];
mcx_gray q[19],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
...
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[8];
x q[14];
x q[12];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[6];
mcx_gray q[18],q[17],q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[6];
mcx_gray q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[1];
x q[16];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
...
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[18],q[16],q[15],q[13],q[12],q[11],q[10],q[2];
x q[10];
x q[19];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[15],q[14],q[13],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[2];
x q[10];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[3];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[12],q[11],q[10],q[2];
x q[14];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[12],q[11],q[0];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[1];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
...
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[6];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[5];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[2];
mcx_gray q[19],q[18],q[16],q[15],q[14],q[13],q[11],q[10],q[1];
x q[10];
x q[16];
x q[19];
x q[17];
mcx_gray q[18],q[17],q[16],q[15],q[13],q[12],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
x q[19];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[11],q[7];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[8];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[6];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[4];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[0];
x q[13];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[11],q[9];
mcx_gray q[19],q[18],q[17],q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[5];
