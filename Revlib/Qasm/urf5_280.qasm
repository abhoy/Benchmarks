...
gate mcx_139945114374192 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
gate mcx_gray q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
gate mcx_gray_139945112384800 q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
qreg q[9];
creg c[9];
x q[0];
cx q[2],q[1];
...
ccx q[8],q[7],q[6];
mcx q[0],q[5],q[6],q[8];
mcx_139945114374192 q[1],q[2],q[3],q[4],q[0];
mcx q[0],q[5],q[6],q[8];
ccx q[8],q[7],q[6];
mcx q[0],q[5],q[6],q[7];
...
x q[3];
mcx q[5],q[6],q[7],q[8],q[4];
mcx_gray_139945112384800 q[0],q[1],q[2],q[3],q[4],q[8];
mcx q[5],q[6],q[7],q[8],q[4];
