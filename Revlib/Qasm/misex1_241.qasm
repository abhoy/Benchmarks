...
gate mcx_139647397162160 q0,q1,q2,q3 { h q3; p(pi/8) q0; p(pi/8) q1; p(pi/8) q2; p(pi/8) q3; cx q0,q1; p(-pi/8) q1; cx q0,q1; cx q1,q2; p(-pi/8) q2; cx q0,q2; p(pi/8) q2; cx q1,q2; p(-pi/8) q2; cx q0,q2; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; h q3; }
gate mcx_gray q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_139647397166048 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
qreg q[15];
creg c[15];
x q[14];
mcx q[14],q[13],q[12],q[11],q[6];
mcx q[14],q[13],q[12],q[11],q[4];
mcx q[14],q[13],q[12],q[11],q[2];
mcx q[14],q[13],q[12],q[11],q[1];
mcx q[14],q[13],q[12],q[11],q[0];
x q[13];
mcx_139647397162160 q[14],q[13],q[12],q[5];
mcx q[14],q[13],q[12],q[2];
mcx q[14],q[13],q[12],q[1];
x q[14];
x q[11];
mcx q[14],q[13],q[12],q[11],q[6];
mcx q[14],q[13],q[12],q[11],q[3];
mcx q[14],q[13],q[12],q[11],q[2];
mcx q[14],q[13],q[12],q[11],q[1];
mcx q[14],q[13],q[12],q[11],q[0];
x q[14];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[4];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[3];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[1];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[0];
mcx q[14],q[13],q[11],q[5];
mcx q[14],q[13],q[11],q[4];
mcx q[14],q[13],q[11],q[3];
mcx q[14],q[13],q[11],q[1];
mcx q[14],q[13],q[11],q[0];
x q[11];
x q[12];
mcx q[14],q[12],q[11],q[4];
ccx q[14],q[12],q[5];
ccx q[14],q[12],q[2];
ccx q[14],q[12],q[1];
ccx q[14],q[12],q[0];
mcx q[13],q[12],q[11],q[5];
mcx q[13],q[12],q[11],q[4];
mcx q[13],q[12],q[11],q[2];
mcx q[13],q[12],q[11],q[1];
mcx q[13],q[12],q[11],q[0];
x q[13];
x q[11];
mcx q[14],q[12],q[11],q[3];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[4];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[3];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[0];
x q[13];
mcx_gray q[14],q[13],q[12],q[11],q[8],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[8],q[4];
mcx_gray q[14],q[13],q[12],q[11],q[8],q[1];
x q[13];
x q[7];
mcx q[14],q[13],q[12],q[7],q[3];
x q[10];
mcx_gray_139647397166048 q[14],q[13],q[12],q[11],q[10],q[7],q[3];
