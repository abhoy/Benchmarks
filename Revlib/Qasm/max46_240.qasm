...
gate mcx_gray_139903904911264 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_gray_139903904911840 q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
gate mcx_gray_139903904913232 q0,q1,q2,q3,q4,q5,q6,q7,q8 { h q8; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7,q8; h q8; }
qreg q[10];
creg c[10];
x q[3];
mcx_gray q[6],q[4],q[3],q[2],q[1],q[0];
mcx_gray_139903904911264 q[9],q[6],q[5],q[4],q[3],q[1],q[0];
x q[7];
mcx_gray q[7],q[6],q[5],q[4],q[3],q[1],q[0];
mcx_gray_139903904911840 q[9],q[8],q[7],q[6],q[4],q[3],q[1],q[0];
x q[7];
x q[9];
mcx_gray q[9],q[8],q[7],q[6],q[3],q[2],q[0];
x q[1];
mcx_gray q[9],q[8],q[6],q[5],q[2],q[1],q[0];
mcx_gray q[9],q[8],q[6],q[5],q[4],q[3],q[1],q[0];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[1],q[0];
x q[3];
x q[1];
x q[4];
mcx_gray q[9],q[8],q[5],q[4],q[3],q[2],q[1],q[0];
mcx_gray q[9],q[8],q[6],q[5],q[4],q[3],q[2],q[0];
x q[8];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[2],q[1],q[0];
mcx_gray q[9],q[8],q[7],q[6],q[2],q[1],q[0];
mcx_gray_139903904913232 q[9],q[8],q[7],q[6],q[5],q[3],q[2],q[1],q[0];
x q[9];
x q[1];
x q[3];
mcx_gray q[9],q[8],q[5],q[4],q[3],q[2],q[1],q[0];
x q[7];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[4],q[3],q[1],q[0];
x q[1];
x q[3];
x q[4];
x q[8];
x q[6];
mcx_gray q[8],q[7],q[6],q[5],q[4],q[3],q[2],q[1],q[0];
mcx_gray q[8],q[7],q[6],q[3],q[2],q[1],q[0];
x q[8];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[2],q[1],q[0];
x q[1];
mcx_gray q[9],q[8],q[6],q[4],q[3],q[1],q[0];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[2],q[1],q[0];
mcx_gray q[9],q[8],q[7],q[6],q[3],q[1],q[0];
x q[9];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[4],q[2],q[1],q[0];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[3],q[2],q[1],q[0];
mcx_gray q[9],q[7],q[6],q[5],q[3],q[2],q[1],q[0];
mcx_gray q[8],q[7],q[6],q[5],q[4],q[3],q[2],q[1],q[0];
x q[1];
x q[7];
x q[8];
x q[6];
x q[5];
mcx_gray q[9],q[8],q[7],q[5],q[4],q[3],q[1],q[0];
mcx_gray q[9],q[8],q[7],q[5],q[4],q[2],q[1],q[0];
x q[9];
mcx_gray q[8],q[7],q[6],q[5],q[3],q[2],q[1],q[0];
mcx_gray q[8],q[7],q[6],q[5],q[2],q[1],q[0];
x q[1];
x q[6];
mcx_gray q[9],q[7],q[6],q[5],q[4],q[3],q[2],q[1],q[0];
x q[8];
mcx_gray q[8],q[6],q[5],q[4],q[3],q[2],q[1],q[0];
mcx_gray q[8],q[6],q[5],q[3],q[2],q[1],q[0];
x q[6];
x q[7];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[4],q[3],q[2],q[0];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[4],q[2],q[0];
x q[2];
x q[4];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[2],q[0];
x q[8];
mcx_gray q[9],q[7],q[6],q[4],q[3],q[2],q[1],q[0];
mcx_gray q[8],q[7],q[6],q[5],q[4],q[2],q[1],q[0];
x q[4];
x q[5];
x q[7];
x q[1];
mcx_gray q[8],q[6],q[5],q[4],q[3],q[2],q[1],q[0];
mcx_gray q[8],q[6],q[5],q[4],q[2],q[1],q[0];
x q[8];
x q[5];
mcx_gray q[8],q[7],q[6],q[5],q[4],q[3],q[2],q[1],q[0];
mcx_gray q[8],q[7],q[6],q[5],q[3],q[2],q[1],q[0];
...
x q[4];
x q[3];
mcx_gray q[9],q[6],q[5],q[4],q[3],q[2],q[1],q[0];
x q[1];
mcx_gray q[9],q[8],q[6],q[5],q[4],q[3],q[2],q[0];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[3],q[2],q[1],q[0];
mcx_gray q[9],q[8],q[6],q[5],q[3],q[2],q[1],q[0];
x q[3];
x q[5];
x q[8];
x q[9];
mcx_gray q[9],q[7],q[6],q[5],q[3],q[2],q[1],q[0];
mcx_gray q[9],q[7],q[6],q[5],q[4],q[3],q[2],q[0];
mcx_gray q[9],q[7],q[6],q[5],q[3],q[2],q[0];
mcx_gray q[9],q[7],q[6],q[5],q[4],q[2],q[1],q[0];
x q[5];
mcx_gray q[9],q[8],q[7],q[6],q[5],q[3],q[2],q[1],q[0];
x q[7];
x q[3];
x q[1];
mcx_gray q[9],q[8],q[7],q[5],q[4],q[3],q[2],q[1],q[0];
