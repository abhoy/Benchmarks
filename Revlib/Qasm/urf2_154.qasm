...
gate mcx_139781135967200 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
gate mcx_gray q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_139781136122928 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_gray_139781136131808 q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
qreg q[8];
creg c[8];
ccx q[0],q[1],q[6];
ccx q[0],q[1],q[5];
...
mcx q[1],q[2],q[3],q[0];
mcx q[2],q[3],q[5],q[1];
mcx_139781135967200 q[0],q[1],q[2],q[3],q[7];
...
mcx q[3],q[5],q[7],q[1];
ccx q[3],q[7],q[0];
mcx_gray_139781136122928 q[0],q[1],q[2],q[3],q[5],q[6],q[7];
...
mcx q[3],q[6],q[7],q[1];
mcx q[2],q[3],q[6],q[7],q[0];
mcx_gray_139781136131808 q[0],q[1],q[2],q[3],q[4],q[5],q[7],q[6];
ccx q[6],q[7],q[4];
ccx q[6],q[7],q[3];
mcx q[0],q[6],q[7],q[2];
ccx q[6],q[7],q[0];
...
mcx_gray q[3],q[4],q[5],q[6],q[7],q[0];
cx q[5],q[6];
mcx_gray q[0],q[1],q[2],q[4],q[6],q[7],q[5];
cx q[5],q[6];
mcx q[1],q[4],q[6],q[7],q[0];
