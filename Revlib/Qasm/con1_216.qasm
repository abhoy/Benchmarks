...
gate mcx_140177386977648 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
qreg q[9];
creg c[9];
cx q[8],q[0];
cx q[4],q[0];
...
x q[4];
x q[6];
mcx_gray q[8],q[7],q[6],q[5],q[4],q[1];
mcx q[8],q[5],q[4],q[1];
x q[8];
ccx q[8],q[7],q[1];
mcx q[8],q[4],q[2],q[0];
ccx q[8],q[4],q[0];
x q[3];
mcx_140177386977648 q[8],q[7],q[4],q[3],q[1];
x q[4];
x q[7];
mcx q[8],q[7],q[2],q[0];
mcx q[8],q[7],q[6],q[5],q[1];
x q[8];
x q[5];
