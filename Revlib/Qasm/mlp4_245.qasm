...
gate mcx_140325487079008 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
gate mcx_gray q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_140325487081744 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_gray_140325487082752 q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
gate mcx_gray_140325485120480 q0,q1,q2,q3,q4,q5,q6,q7,q8 { h q8; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7,q8; h q8; }
qreg q[16];
creg c[16];
ccx q[14],q[10],q[4];
mcx q[14],q[11],q[10],q[6];
ccx q[14],q[11],q[5];
ccx q[15],q[11],q[6];
mcx_140325487079008 q[15],q[14],q[11],q[9],q[7];
mcx q[15],q[14],q[11],q[9],q[6];
mcx q[15],q[13],q[11],q[9],q[5];
ccx q[15],q[9],q[4];
ccx q[14],q[9],q[3];
ccx q[13],q[10],q[3];
ccx q[13],q[11],q[4];
...
ccx q[12],q[10],q[2];
mcx_gray q[15],q[14],q[12],q[11],q[9],q[6];
mcx_gray q[15],q[14],q[12],q[11],q[9],q[5];
ccx q[15],q[8],q[3];
mcx q[15],q[12],q[11],q[8],q[5];
mcx q[15],q[12],q[11],q[8],q[4];
ccx q[15],q[10],q[5];
mcx q[13],q[12],q[9],q[8],q[5];
mcx q[13],q[12],q[9],q[8],q[4];
mcx q[13],q[12],q[9],q[8],q[3];
mcx q[13],q[12],q[9],q[8],q[2];
mcx_gray_140325487081744 q[15],q[14],q[12],q[11],q[10],q[8],q[6];
mcx_gray q[15],q[14],q[12],q[11],q[10],q[8],q[4];
ccx q[14],q[8],q[2];
mcx_gray q[15],q[13],q[11],q[10],q[8],q[6];
mcx_gray q[15],q[13],q[11],q[10],q[8],q[5];
mcx q[15],q[13],q[10],q[8],q[6];
mcx q[15],q[13],q[10],q[8],q[5];
mcx q[15],q[13],q[10],q[8],q[4];
ccx q[12],q[9],q[1];
mcx q[14],q[12],q[10],q[8],q[3];
ccx q[12],q[8],q[0];
x q[8];
mcx_gray_140325487082752 q[15],q[14],q[13],q[12],q[10],q[9],q[8],q[6];
mcx_gray q[13],q[12],q[10],q[9],q[8],q[3];
mcx_gray q[14],q[13],q[10],q[9],q[8],q[5];
mcx_gray q[14],q[13],q[10],q[9],q[8],q[4];
x q[8];
x q[14];
mcx_gray q[15],q[14],q[12],q[11],q[10],q[9],q[8],q[7];
mcx_gray q[15],q[14],q[12],q[11],q[10],q[9],q[8],q[6];
x q[8];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[8],q[7];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[8],q[6];
mcx_gray q[14],q[13],q[12],q[11],q[9],q[8],q[5];
x q[11];
mcx_gray q[15],q[14],q[13],q[11],q[10],q[9],q[8],q[6];
mcx_gray q[15],q[13],q[11],q[10],q[9],q[8],q[6];
mcx_gray q[15],q[13],q[12],q[11],q[10],q[9],q[8],q[6];
x q[8];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[4];
x q[14];
x q[15];
mcx_gray q[15],q[13],q[12],q[11],q[9],q[8],q[5];
mcx_gray q[15],q[14],q[12],q[11],q[10],q[8],q[5];
mcx_gray q[15],q[14],q[12],q[11],q[10],q[8],q[4];
x q[11];
x q[14];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[8],q[4];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[9],q[5];
x q[14];
x q[10];
mcx_gray q[14],q[12],q[11],q[10],q[9],q[6];
mcx_gray q[14],q[12],q[11],q[10],q[9],q[4];
mcx_gray q[13],q[12],q[11],q[10],q[9],q[8],q[4];
mcx_gray q[13],q[12],q[11],q[10],q[9],q[8],q[5];
mcx_gray q[13],q[12],q[11],q[10],q[9],q[5];
x q[12];
mcx_gray q[14],q[13],q[12],q[9],q[8],q[5];
mcx_gray q[14],q[13],q[12],q[9],q[8],q[4];
mcx_gray q[14],q[13],q[12],q[9],q[8],q[3];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[5];
mcx_gray_140325485120480 q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[6];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[9],q[8],q[5];
x q[10];
x q[15];
x q[14];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[7];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[6];
x q[14];
x q[12];
x q[13];
mcx_gray q[15],q[14],q[13],q[9],q[8],q[4];
mcx_gray q[15],q[14],q[13],q[10],q[9],q[6];
mcx_gray q[15],q[14],q[13],q[10],q[9],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[6];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[5];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[4];
x q[10];
mcx_gray q[15],q[14],q[13],q[10],q[9],q[8],q[5];
x q[8];
x q[12];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[7];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[6];
x q[12];
x q[8];
x q[15];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[6];
x q[10];
mcx_gray q[15],q[14],q[13],q[11],q[10],q[6];
x q[15];
x q[9];
mcx_gray q[15],q[14],q[11],q[10],q[9],q[7];
mcx_gray q[14],q[13],q[12],q[10],q[9],q[8],q[6];
mcx_gray q[14],q[13],q[12],q[10],q[9],q[8],q[5];
mcx_gray q[14],q[13],q[12],q[10],q[9],q[8],q[4];
mcx_gray q[15],q[13],q[12],q[11],q[9],q[8],q[5];
x q[13];
mcx_gray q[14],q[13],q[12],q[11],q[10],q[9],q[5];
mcx_gray q[14],q[13],q[11],q[10],q[9],q[5];
x q[14];
mcx_gray q[15],q[14],q[13],q[10],q[9],q[8],q[6];
mcx_gray q[15],q[14],q[13],q[10],q[9],q[8],q[5];
mcx_gray q[15],q[14],q[13],q[11],q[10],q[9],q[8],q[7];
x q[14];
x q[15];
x q[13];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[6];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[9],q[8],q[6];
x q[13];
x q[15];
x q[10];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[8],q[7];
