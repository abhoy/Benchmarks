...
gate mcx_gray_140287719903520 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_140287719903232 q0,q1,q2,q3 { h q3; p(pi/8) q0; p(pi/8) q1; p(pi/8) q2; p(pi/8) q3; cx q0,q1; p(-pi/8) q1; cx q0,q1; cx q1,q2; p(-pi/8) q2; cx q0,q2; p(pi/8) q2; cx q1,q2; p(-pi/8) q2; cx q0,q2; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; h q3; }
qreg q[10];
creg c[10];
x q[5];
mcx q[8],q[7],q[5],q[4],q[1];
x q[3];
mcx_gray q[9],q[7],q[5],q[4],q[3],q[1];
mcx_gray q[7],q[6],q[5],q[4],q[3],q[0];
mcx_gray_140287719903520 q[9],q[8],q[6],q[5],q[4],q[3],q[2];
mcx_gray q[9],q[8],q[6],q[5],q[4],q[3],q[1];
x q[3];
x q[9];
mcx_140287719903232 q[9],q[8],q[4],q[1];
mcx_gray q[9],q[7],q[6],q[5],q[3],q[0];
mcx q[9],q[7],q[6],q[3],q[0];
mcx q[9],q[8],q[7],q[5],q[1];
x q[9];
x q[4];
mcx_gray q[9],q[8],q[6],q[5],q[4],q[2];
mcx_gray q[9],q[8],q[6],q[5],q[4],q[1];
x q[9];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[2];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[0];
mcx q[9],q[5],q[4],q[0];
x q[5];
x q[3];
mcx_gray q[9],q[6],q[5],q[4],q[3],q[1];
x q[9];
x q[4];
x q[8];
mcx q[9],q[8],q[6],q[5],q[2];
mcx q[9],q[8],q[6],q[5],q[0];
mcx_gray q[9],q[8],q[6],q[5],q[4],q[3],q[2];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[1];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[0];
x q[4];
mcx q[8],q[7],q[5],q[4],q[0];
x q[9];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[2];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[1];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[0];
...
x q[6];
ccx q[9],q[6],q[2];
mcx q[8],q[6],q[5],q[4],q[1];
mcx q[8],q[6],q[5],q[4],q[0];
mcx_gray q[9],q[6],q[5],q[4],q[3],q[1];
mcx q[9],q[8],q[6],q[1];
mcx q[9],q[8],q[6],q[0];
x q[8];
...
x q[5];
mcx_gray q[9],q[8],q[6],q[5],q[4],q[3],q[2];
mcx_gray q[9],q[6],q[5],q[4],q[3],q[2];
x q[4];
x q[9];
mcx q[8],q[6],q[5],q[0];
x q[5];
x q[7];
mcx_gray q[9],q[7],q[6],q[5],q[3],q[0];
mcx_gray q[9],q[7],q[6],q[4],q[3],q[2];
mcx q[9],q[8],q[7],q[5],q[0];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[2];
x q[3];
mcx_gray q[9],q[8],q[7],q[6],q[4],q[3],q[1];
x q[5];
x q[4];
