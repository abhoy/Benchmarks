...
gate mcx_140385232376480 q0,q1,q2,q3 { h q3; p(pi/8) q0; p(pi/8) q1; p(pi/8) q2; p(pi/8) q3; cx q0,q1; p(-pi/8) q1; cx q0,q1; cx q1,q2; p(-pi/8) q2; cx q0,q2; p(pi/8) q2; cx q1,q2; p(-pi/8) q2; cx q0,q2; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q1,q3; p(pi/8) q3; cx q2,q3; p(-pi/8) q3; cx q0,q3; h q3; }
gate mcx_gray_140385232377872 q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
gate mcx_gray_140385232378352 q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
qreg q[16];
creg c[16];
x q[14];
ccx q[15],q[14],q[8];
...
ccx q[14],q[13],q[6];
ccx q[14],q[13],q[3];
mcx q[14],q[13],q[12],q[10],q[7];
mcx q[14],q[13],q[12],q[10],q[6];
mcx q[14],q[13],q[12],q[10],q[5];
mcx q[14],q[13],q[12],q[10],q[3];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[9],q[5];
x q[14];
ccx q[15],q[14],q[7];
ccx q[15],q[14],q[0];
mcx_140385232376480 q[15],q[14],q[13],q[6];
mcx q[15],q[14],q[13],q[4];
mcx q[15],q[14],q[13],q[12],q[0];
cx q[15],q[5];
cx q[15],q[4];
x q[12];
x q[11];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[9],q[6];
mcx_gray_140385232377872 q[15],q[14],q[13],q[12],q[11],q[10],q[9],q[4];
x q[14];
mcx q[15],q[14],q[12],q[5];
mcx q[15],q[14],q[12],q[4];
mcx q[15],q[14],q[12],q[3];
mcx_gray_140385232378352 q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[4];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[2];
x q[10];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[3];
mcx q[15],q[14],q[13],q[10],q[3];
mcx q[14],q[13],q[12],q[10],q[5];
x q[14];
mcx q[15],q[13],q[12],q[10],q[5];
mcx q[15],q[13],q[12],q[10],q[4];
mcx q[15],q[13],q[12],q[10],q[2];
mcx_gray q[15],q[13],q[12],q[11],q[10],q[9],q[5];
mcx_gray q[15],q[13],q[12],q[11],q[10],q[9],q[2];
x q[12];
x q[11];
x q[10];
x q[9];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[8];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[7];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[6];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[5];
x q[9];
x q[13];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[8];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[7];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[6];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[5];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[4];
mcx q[15],q[13],q[12],q[10],q[6];
mcx q[15],q[13],q[12],q[10],q[5];
x q[15];
x q[12];
mcx q[15],q[14],q[13],q[12],q[8];
mcx q[15],q[14],q[13],q[12],q[7];
x q[15];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[8];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[7];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[6];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[5];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[4];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[1];
x q[9];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[9],q[7];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[9],q[6];
mcx_gray q[15],q[14],q[13],q[12],q[10],q[9],q[5];
x q[15];
x q[9];
x q[14];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[9],q[6];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[9],q[5];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[9],q[1];
x q[9];
mcx q[15],q[14],q[13],q[9],q[8];
mcx q[15],q[14],q[13],q[9],q[6];
mcx q[15],q[14],q[13],q[9],q[5];
mcx q[15],q[14],q[13],q[9],q[1];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[8];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[6];
mcx_gray q[15],q[14],q[13],q[12],q[9],q[1];
x q[15];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[5];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[3];
mcx_gray q[15],q[14],q[13],q[12],q[11],q[1];
x q[14];
x q[10];
mcx_gray q[15],q[14],q[13],q[10],q[9],q[5];
