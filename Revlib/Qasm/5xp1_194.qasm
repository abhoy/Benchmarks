...
gate mcx_140053653652288 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
gate mcx_gray q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_140053653654064 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_gray_140053653654736 q0,q1,q2,q3,q4,q5,q6,q7 { h q7; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7; h q7; }
qreg q[17];
creg c[17];
cx q[10],q[9];
cx q[10],q[8];
...
cx q[16],q[4];
ccx q[16],q[14],q[5];
mcx q[12],q[11],q[10],q[9];
mcx q[12],q[11],q[10],q[7];
...
ccx q[14],q[13],q[3];
x q[10];
mcx_140053653652288 q[16],q[12],q[11],q[10],q[9];
mcx q[16],q[12],q[11],q[10],q[8];
mcx q[16],q[12],q[11],q[10],q[0];
ccx q[12],q[10],q[9];
ccx q[12],q[10],q[7];
cx q[14],q[2];
...
x q[13];
mcx_gray q[16],q[15],q[14],q[13],q[10],q[6];
x q[10];
x q[11];
mcx q[16],q[15],q[11],q[10],q[8];
mcx q[16],q[15],q[11],q[10],q[7];
mcx q[16],q[15],q[12],q[11],q[8];
x q[10];
mcx_gray_140053653654064 q[16],q[15],q[14],q[13],q[11],q[10],q[8];
mcx_gray q[16],q[15],q[14],q[13],q[11],q[10],q[7];
x q[10];
x q[12];
mcx q[12],q[11],q[10],q[9];
...
mcx q[12],q[11],q[10],q[7];
x q[10];
mcx_gray_140053653654736 q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
x q[11];
x q[13];
x q[14];
x q[12];
x q[16];
mcx q[16],q[15],q[13],q[5];
mcx q[16],q[14],q[13],q[10],q[6];
mcx q[16],q[15],q[10],q[7];
mcx q[16],q[15],q[10],q[6];
mcx_gray q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[0];
mcx_gray q[16],q[15],q[14],q[13],q[11],q[10],q[7];
x q[15];
mcx_gray q[16],q[15],q[14],q[13],q[10],q[7];
x q[10];
x q[16];
mcx q[16],q[15],q[11],q[7];
mcx q[16],q[15],q[14],q[10],q[6];
x q[12];
mcx_gray q[16],q[15],q[14],q[12],q[11],q[10],q[8];
mcx_gray q[16],q[15],q[14],q[12],q[10],q[8];
x q[16];
mcx q[16],q[15],q[14],q[13],q[7];
mcx q[16],q[15],q[14],q[13],q[6];
mcx q[16],q[15],q[14],q[13],q[5];
x q[13];
mcx_gray q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[9];
mcx_gray q[16],q[15],q[14],q[13],q[12],q[11],q[10],q[8];
mcx_gray q[16],q[15],q[14],q[13],q[11],q[10],q[7];
mcx_gray q[16],q[15],q[14],q[13],q[10],q[7];
x q[14];
mcx_gray q[16],q[15],q[14],q[12],q[11],q[10],q[9];
mcx_gray q[16],q[15],q[14],q[12],q[11],q[10],q[8];
x q[11];
mcx q[15],q[14],q[11],q[10],q[7];
